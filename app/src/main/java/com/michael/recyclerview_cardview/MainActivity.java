package com.michael.recyclerview_cardview;
    ...
    public void buildRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(new ExampleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                String title = ((TextView) mRecyclerView.findViewHolderForAdapterPosition(position).itemView.findViewById(R.id.textView2)).getText().toString();
                Toast.makeText(getApplicationContext(), "Position" + position + title, Toast.LENGTH_SHORT).show();
